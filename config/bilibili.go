...
func GetBilibiliUrl() map[string]interface{} {
	...
	urlConfig["DO_YIFARUHUN"] = "https://api.vc.bilibili.com/dynamic_svr/v1/dynamic_svr/get_dynamic_detail?dynamic_id=602273948136384836"  //来自转发抽奖娘的动态id
	urlConfig["DO_CHOUJIANG"] = "https://api.bilibili.com/x/lottery/do"  //抽奖链接
	urlConfig["DO_CHOUJIANGNUM"] = "https://api.bilibili.com/x/lottery/mytimes?sid="  //查询抽奖次数
